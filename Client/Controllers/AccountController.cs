...
namespace Client.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            return HandleUserInput(() => this._identityService.Login(model), model, nameof(Login));
        }
        ...
        {
            return HandleUserInput(() => this._identityService.Register(model), model, nameof(Register));
        }
